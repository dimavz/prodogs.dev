					...
					<div class="pull-left form-inline">
						<div class="btn-group">
							<button class="btn btn-small btn-primary"
									data-calendar-nav="prev"><?php echo HTMLFormatHelper::icon('arrow-180.png'); ?> <?php echo JText::_('Предыдущий'); ?>
							</button>
							<button class="btn btn-small" data-calendar-nav="today"><?php echo JText::_('Сегодня'); ?></button>
							<button class="btn btn-small btn-primary" data-calendar-nav="next">
								<?php echo JText::_('Следующий'); ?> <?php echo HTMLFormatHelper::icon('arrow.png'); ?></button>
						</div>
					</div>
				<?php endif; ?>
			</td>
					...
					<div class="btn-group">
						<?php if($params->get('tmpl_params.cal_view_year')): ?>
							<button class="btn btn-small btn-warning"
									data-calendar-view="year"><?php echo JText::_('Год'); ?></button>
						<?php endif; ?>
						<?php if($params->get('tmpl_params.cal_view_month')): ?>
							<button class="btn btn-small btn-warning active"
									data-calendar-view="month"><?php echo JText::_('Месяц'); ?></button>
						<?php endif; ?>
						<?php if($params->get('tmpl_params.cal_view_week')): ?>
							<button class="btn btn-small btn-warning"
									data-calendar-view="week"><?php echo JText::_('Неделя'); ?></button>
						<?php endif; ?>
						<?php if($params->get('tmpl_params.cal_view_day')): ?>
							<button class="btn btn-small btn-warning"
									data-calendar-view="day"><?php echo JText::_('День'); ?></button>
						<?php endif; ?>
					</div>
				</div>
			</td>
