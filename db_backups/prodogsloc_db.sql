...
-- Дамп данных таблицы prodogs.loc.dogs_assets: ~101 rows (приблизительно)
...
INSERT INTO `dogs_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(18, 1, 45, 102, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1}}'),
	...
	(57, 1, 133, 142, 1, 'com_cobalt', 'com_cobalt', '{}'),
	(58, 18, 78, 79, 2, 'com_modules.module.88', 'Cobalt - Module - Categories', '{}'),
	(59, 18, 80, 81, 2, 'com_modules.module.89', 'Cobalt - Module - Filters', '{}'),
	(60, 18, 82, 83, 2, 'com_modules.module.90', 'Cobalt - Module - Who Follows User', '{}'),
	(61, 18, 84, 85, 2, 'com_modules.module.91', 'Cobalt - Module - Whom User Follows', '{}'),
	(62, 18, 86, 87, 2, 'com_modules.module.92', 'Cobalt - Module - Notifications', '{}'),
	(63, 18, 88, 89, 2, 'com_modules.module.93', 'Cobalt - Module - Article Participants', '{}'),
	(64, 18, 90, 91, 2, 'com_modules.module.94', 'Cobalt - Module - Records', '{}'),
	(65, 18, 92, 93, 2, 'com_modules.module.95', 'Cobalt - Module - Section Statictics', '{}'),
	(66, 18, 94, 95, 2, 'com_modules.module.96', 'Cobalt - Module - Submit Button', '{}'),
	(67, 18, 96, 97, 2, 'com_modules.module.97', 'Cobalt - Module - Tag Cloud', '{}'),
	(68, 18, 98, 99, 2, 'com_modules.module.98', 'Cobalt - Module - User Statictics', '{}'),
	(69, 57, 134, 135, 2, 'com_cobalt.type.1', 'Cobalt Content Type: Собака', '{}'),
	(70, 1, 143, 144, 1, 'com_cobalt.field.1', 'Изображение', '{}'),
	(71, 1, 145, 146, 1, 'com_cobalt.field.2', 'Примечание', '{}'),
	(72, 1, 147, 148, 1, 'com_cobalt.field.3', 'Кличка домашняя', '{}'),
	(73, 1, 149, 150, 1, 'com_cobalt.field.4', 'Кличка по родословной', '{}'),
	(74, 1, 151, 152, 1, 'com_cobalt.section.1', '', '{}'),
	(75, 57, 136, 137, 2, 'com_cobalt.type.2', 'Cobalt Content Type: Порода', '{}'),
	(76, 1, 153, 154, 1, 'com_cobalt.field.5', 'Изображение', '{}'),
	(77, 1, 155, 156, 1, 'com_cobalt.field.6', 'Описание породы', '{}'),
	(78, 1, 157, 158, 1, 'com_cobalt.section.2', '', '{}'),
	(79, 1, 159, 160, 1, 'com_cobalt.field.7', 'Собака', '{}'),
	(80, 1, 161, 162, 1, 'com_cobalt.field.8', 'Порода', '{}'),
	(81, 16, 40, 41, 2, 'com_menus.menu.2', 'Меню Собаковода', '{}'),
	(82, 18, 100, 101, 2, 'com_modules.module.99', 'Меню Собаковода', '{}'),
	(83, 1, 163, 164, 1, 'com_cobalt.field.9', 'Пол', '{}'),
	(84, 1, 165, 166, 1, 'com_cobalt.field.10', 'Дата рождения', '{}'),
	(85, 1, 167, 168, 1, 'com_cobalt.field.11', 'Дата смерти', '{}'),
	(86, 1, 169, 170, 1, 'com_cobalt.field.12', 'Номер РКФ/FCI', '{}'),
	(87, 1, 171, 172, 1, 'com_cobalt.field.13', 'Клеймо/Chip', '{}'),
	(88, 1, 173, 174, 1, 'com_cobalt.field.14', 'Окрас', '{}'),
	(89, 1, 175, 176, 1, 'com_cobalt.field.15', 'Высота в холке', '{}'),
	(90, 1, 177, 178, 1, 'com_cobalt.field.16', 'Вес', '{}'),
	(91, 1, 179, 180, 1, 'com_cobalt.field.17', 'Место нахождения', '{}'),
	(92, 57, 138, 139, 2, 'com_cobalt.type.3', 'Cobalt Content Type: Альбом', '{}'),
	(93, 1, 181, 182, 1, 'com_cobalt.field.18', 'Галлерея', '{}'),
	(94, 1, 183, 184, 1, 'com_cobalt.section.3', '', '{}'),
	(95, 1, 185, 186, 1, 'com_cobalt.field.19', 'Описание альбома', '{}'),
	(96, 1, 187, 188, 1, 'com_cobalt.field.20', 'Собака', '{}'),
	(97, 1, 189, 190, 1, 'com_cobalt.field.21', 'Альбом', '{}'),
	(98, 57, 140, 141, 2, 'com_cobalt.type.4', 'Cobalt Content Type: Видеоролик', '{}'),
	(99, 1, 191, 192, 1, 'com_cobalt.section.4', '', '{}'),
	(100, 1, 193, 194, 1, 'com_cobalt.field.22', 'Ссылка на видео', '{}'),
	(101, 1, 195, 196, 1, 'com_cobalt.field.23', 'Описание ролика', '{}'),
	(102, 1, 197, 198, 1, 'com_cobalt.field.24', 'Собака', '{}'),
	(103, 1, 199, 200, 1, 'com_cobalt.field.25', 'Видеоролик', '{}');
...
INSERT INTO `dogs_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1539263991}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	...
	(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":1,"lastrun":1539242710,"unique_id":"646b159ba1414416ca68f2fb7a5938d6af1af090","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
-- Дамп данных таблицы prodogs.loc.dogs_js_res_fields: 25 rows
...
-- Дамп данных таблицы prodogs.loc.dogs_js_res_fields_group: 5 rows
...
INSERT INTO `dogs_js_res_fields_group` (`id`, `title`, `type_id`, `ordering`, `description`, `checked_out`, `checked_out_time`, `icon`) VALUES
	...
	(2, 'Представители породы', 2, 1, '', 0, '0000-00-00 00:00:00', 'animal-dog.png'),
	(3, 'Местоположение', 1, 2, '', 0, '0000-00-00 00:00:00', 'marker.png'),
	(4, 'Альбомы', 1, 3, '', 0, '0000-00-00 00:00:00', 'images-stack.png'),
	(5, 'Видеоролики', 1, 4, '', 0, '0000-00-00 00:00:00', 'clapperboard.png');
...
-- Дамп данных таблицы prodogs.loc.dogs_js_res_sections: 4 rows
...
-- Дамп данных таблицы prodogs.loc.dogs_js_res_types: 4 rows
...
-- Дамп данных таблицы prodogs.loc.dogs_menu: ~36 rows (приблизительно)
...
-- Дамп данных таблицы prodogs.loc.dogs_menu_types: ~0 rows (приблизительно)
...
-- Дамп данных таблицы prodogs.loc.dogs_modules: ~28 rows (приблизительно)
...
-- Дамп данных таблицы prodogs.loc.dogs_modules_menu: ~19 rows (приблизительно)
...
INSERT INTO `dogs_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('lc5l5bj74ed2ri89gvcdbqj611', 0, 1, '1539269451', 'joomla|s:2032:"";', 0, ''),
	('vedksb5c7u71digcn29pv5a654', 1, 0, '1539269407', 'joomla|s:3040:"";', 784, 'admin');
...
INSERT INTO `dogs_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1539260595, ''),
	(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1539260615, ''),
	(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1539260635, '');
...
INSERT INTO `dogs_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(784, 'Super User', 'admin', 'zatulenko@gmail.com', '$2y$10$7E7bc53LW240v3IQgxqsxeAsN7COWdQG4MzyXSaTMoJhGrPY.2nXq', 0, 1, '2018-10-05 08:34:45', '2018-10-11 12:40:19', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
	(785, 'test', 'test', 'test@mail.ru', '$2y$10$4YDroBqTShV7HZa2wUygh.7h7vzv55VoQ.XKUhalgPB6DGVL5v9zu', 0, 0, '2018-10-11 12:23:53', '2018-10-11 14:50:44', '', '{}', '0000-00-00 00:00:00', 0, '', '', 0);
