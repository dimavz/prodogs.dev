...
-- Дамп данных таблицы prodogs.dev.dogs_assets: ~53 rows (приблизительно)
...
-- Дамп данных таблицы prodogs.dev.dogs_extensions: ~164 rows (приблизительно)
...
-- Дамп данных таблицы prodogs.dev.dogs_update_sites_extensions: ~3 rows (приблизительно)
